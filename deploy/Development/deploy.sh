...
dockerImage=$ecr/party-monsterzz:latest
...
#Update
aws ecs update-service --cluster PM-Cluster --service PM-Service --task-definition $taskDefinitionArn --force-new-deployment > /dev/null && \
